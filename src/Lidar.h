...
public:
	 ...
	 * */
	std::pair<lidar_sample *, std::size_t> get_scan_as_lidar_samples(bool filter_quality = false) const;

	/*
	 * Returns scan data in the form of x-y pairs
	 * */
	std::pair<point *, std::size_t> get_scan_as_xy(bool filter_quality = false) const;
